...
BEST_WEIGHTS = {
    ...
    'mn40': {
        1024: {
            'cutmix_k_dgcnn': 'pretrain/mn40/cutmix_k_dgcnn.pth',
            'cutmix_r_dgcnn': 'pretrain/mn40/cutmix_r_dgcnn.pth',
            'cutmix_k_pointnet': 'pretrain/mn40/cutmix_k_pointnet.pth',
            'cutmix_r_pointnet': 'pretrain/mn40/cutmix_r_pointnet.pth',
            'pgd_dgcnn': 'pretrain/mn40/pgd_dgcnn.pth',
            'pgd_pointnet': 'pretrain/mn40/pgd_pointnet.pth',
        },
    },
