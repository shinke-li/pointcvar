...
if __name__ == "__main__":
    ...
    parser.add_argument('--data_root', type=str,
                        default='data/modelnet40.npz')
    parser.add_argument('--model', type=str, default='pointnet', metavar='N',
                        choices=['pgd_pointnet', 'cutmix_k_pointnet', 'pgd_dgcnn', 'cutmix_k_dgcnn',
                                 'pct', 'dgcnn', 'pointnet', 'gdanet'],
                        help='Model to use, [dgcnn, pointnet, pgd_pointnet, cutmix_k_dgcnn, pgd_dgcnn,cutmix_k_pointnet, pct, gdanet]')
