...
from model import DGCNN, PointNetCls, PointNet2ClsSsg, PointConvDensityClsSsg, Args
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model', type=str, default='cutmix_k_dgcnn', metavar='N',
                        choices=['pgd_pointnet', 'cutmix_r_pointnet','cutmix_k_dgcnn','cutmix_r_dgcnn',
                                 'pgd_dgcnn', 'mixup_dgcnn', 'cutmix_k_pointnet','dgcnn','pointnet'],
                        help='Model to use, [dgcnn, pointnet, mixup_dgcnn, pgd_pointnet, cutmix_r_pointnet, cutmix_k_dgcnn, cutmix_r_dgcnn,pgd_dgcnn,cutmix_k_pointnet]')
